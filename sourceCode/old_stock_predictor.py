...
def historical_prediction(stock, startArray, endArray, interval, metric):
    ...
    except: return False #f'stock {stock} does not have enough associated data' 
    #model = stockModel.stock_LSTM()
...
def get_historical_data(stock_ticker, start, end, interval, metric):
	#start = [2019,11,7,9,30]
	#end = [2019,11,7,11,30]
	prediction = historical_prediction(stock_ticker, start, end, interval, metric)
	return prediction
